...
def GenerateForwarders():
    ...
    asm_file.write('; AUTOGENERATED - DO NOT EDIT!\n')
    ...
    for index in range(len(names)):
        ...
        asm_file.write(';    int3\n')
        asm_file.write('%ifdef ICD_LAZY_LOAD\n')
        asm_file.write('    mov   xAX, [NAME(g_hmodICD) xWrtRIP]\n')
        asm_file.write('    test  xAX, xAX\n')
        asm_file.write('    jnz   .already_loaded\n')
        asm_file.write('    call  NAME(VBoxLoadICD)\n')
        asm_file.write('.already_loaded:\n')
        asm_file.write('%endif\n')
        asm_file.write('    mov   xAX, [NAME(pfn_%s) xWrtRIP]\n' % fn)
        asm_file.write('    test  xAX, xAX\n')
        asm_file.write('    jz    .return\n')
        asm_file.write('    jmp   xAX\n')
        asm_file.write('.return:\n')
